...
export const dai = new StableBond({
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0x9117A9eB5a53018E350a37425C0b749Bc4824851", // OlympusBondDepository
      reserveAddress: "0x130966628846bfd36ff31a822705796e8cb8c18d", // DAI
    },
    [NetworkID.Testnet]: {
...
export const ohm = new StableBond({
  name: "tst",
  displayName: "TEST",
  bondToken: "TEST",
  isAvailable: { [NetworkID.Mainnet]: true, [NetworkID.Testnet]: false },
